...
import updateFavourites from '../Redux/Actions/updateFavourites';
...
export default function Home() {
	...
	let dbFavourites = user2?.Favourites;
	...
	useEffect(() => {
		...
		if (dbFavourites) {
			console.log('PQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ');
			dispatch(updateFavourites(dbFavourites));
		}
		dispatch(getEvents());
		/* return () => {}; */
